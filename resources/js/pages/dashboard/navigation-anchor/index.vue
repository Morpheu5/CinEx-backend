    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="p-4">
            <div class="">
                ...
                <Button asChild>
                    <Link class="" :href="route('dashboard.navigation-anchor.create')"> <fa icon="fa-solid fa-pen-to-square" /> New </Link>
                </Button>
            </div>
            ...
            <table class="my-3 w-full [&>*>tr>*]:px-4 [&>*>tr>*]:py-3">
                ...
                <tbody>
                    <tr v-for="a in props.anchors" :key="a.id" class="border-t">
                        <td>
                            <Button asChild>
                                <Link :href="route('dashboard.navigation-anchor.edit', a.id)" class="underline">
                        ...
                        <td class="">
                            <Link :href="route('dashboard.photosphere.show', a.photosphere_id)">{{ a.photosphere?.name }}</Link>
                        </td>
                        <td class="">
                            <span v-if="a.target"
                                ><Link :href="route('dashboard.photosphere.show', a.target.id)">{{ a.target.name }}</Link></span
                            >
