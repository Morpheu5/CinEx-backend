...
* @see app/Http/Controllers/PhotoController.php:12
* @route '/photos'
*/
...
* @see app/Http/Controllers/PhotoController.php:27
* @route '/photos/{photo}'
*/
...
* @see app/Http/Controllers/PhotoController.php:43
* @route '/photos/{photo}'
*/
...
const PhotoController = { index, store, show, update, destroy }
