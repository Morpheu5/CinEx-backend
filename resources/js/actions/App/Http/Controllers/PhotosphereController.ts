...
* @see app/Http/Controllers/PhotosphereController.php:165
* @route '/photosphere/{photosphere}'
*/
...
* @see app/Http/Controllers/PhotosphereController.php:263
* @route '/photosphere/{photosphere}'
*/
...
* @see app/Http/Controllers/PhotosphereController.php:140
