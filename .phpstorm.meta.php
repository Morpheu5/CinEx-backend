...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/morpheu5/web/cinex/backend/public/storage' => 'string',
            ...
            'typescript-transformer.autoload_dev' => 'boolean',
            'typescript-transformer.printers' => 'array',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/morpheu5/web/cinex/backend/public/storage','inertia.ssr.enabled',
...
'typescript-transformer.transform_to_native_enums','typescript-transformer.transform_null_to_optional','typescript-transformer.autoload_dev','typescript-transformer.printers','data.date_format',
...
'signed','throttle','verified',);
        registerArgumentsSet('routes', 'home','user.index','user.store','user.show',
'user.update','user.destroy','api.v1.theatre.index','api.v1.theatre.show','api.v1.photosphere.index',
'api.v1.photosphere.show','api.v1.gallery.index','api.v1.gallery.show','api.v1.photo.index','api.v1.photo.show',
'api.v1.navigation-anchor.index','api.v1.navigation-anchor.show','api.v1.theatre.store','api.v1.theatre.update','api.v1.theatre.destroy',
'api.v1.photosphere.store','api.v1.photosphere.update','api.v1.photosphere.destroy','api.v1.gallery.store','api.v1.gallery.update',
'api.v1.gallery.destroy','api.v1.photo.store','api.v1.photo.update','api.v1.photo.destroy','api.v1.navigation-anchor.store',
'api.v1.navigation-anchor.update','api.v1.navigation-anchor.destroy','photosphere.image','photo.image','viewer.index',
'viewer.theatre.show','viewer.photosphere.show','admin','admin.theatre.index','admin.theatre.create',
'admin.theatre.show','admin.theatre.edit','admin.photosphere.index','admin.photosphere.create','admin.photosphere.show',
'admin.photosphere.edit','admin.gallery.index','admin.gallery.create','admin.gallery.show','admin.gallery.edit',
'admin.navigation-anchor.index','admin.navigation-anchor.create','admin.navigation-anchor.show','admin.navigation-anchor.edit',
'profile.edit','profile.update','profile.destroy','password.edit','password.update',
'appearance','register','register.store','login','login.store',
'password.request','password.email','password.reset','password.store','verification.notice',
'verification.verify','verification.send','password.confirm','password.confirm.store','logout',
'storage.local',);
